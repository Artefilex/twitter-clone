...
export default function Footer (){
    return (
        <footer className="mb-4 px-4 flex flex-wrap gap-2 text-[#71767b] text-[13px] leading-4">
     ...
     <Popover className={"relative leading-4 inline-flex"} > 
            ...
            <Popover.Panel className={"w-[150px] max-w-[384px] bg-black rounded-xl grid absolute bottom-0 right-0 shadow-box overflow-hidden "}> 
