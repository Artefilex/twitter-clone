...
import {setBackgroundColor, setColor , setBoxShadow} from "../../store/appearance/actions"
    ...
    <div className="w-[600px] ">
      ...
      <div className="p-8 pt-0">
        ...
        <div className="border border-[color:var(--background-third)] px-4 py-3 flex gap-3 rounded-2xl">
         <img src="https://pbs.twimg.com/profile_images/1683899100922511378/5lY42eHs_normal.jpg" alt=""  className="w-10 h-10 rounded-full object-cover"/>

          <div className="flex-1 flex flex-col">
              <header className="mb-0.5 text-[15px] font-bold leading-5 flex items-center ml-0.5" >  X 
               <svg viewBox="0 0 22 22"  className="text-[color:var(--color-primary)] ml-0.5" width={18.75} height={18.75}  >
               ...
               <div className="leading-5 text-[15px] text-[color:var(--color-base)]">
                X'in merkezinde, tıpkı bunun gibi gönderi denen kısa mesajlar yatar. Gönderiler; fotoğraflar, videolar, bağlantılar, metinler, etiketler ve <Link className="text-[color:var(--color-primary)] hover:underline" to={"/x"} >@X </Link> gibi bahsetmeler içerebilir. 
               </div>
          </div>  
        </div>
     </div>
     <div >
      <h6 className="text-left text-[color:var(--color-subbase)] w-full mb-1 leading-5 text-[13px] font-bold ">Arka plan</h6>
     ...
     className={classNames("h-16 px-5 bg-[#15202b] text-[#f7f9f9] font-bold border border-white/10  rounded ", {
      " !border-[color:var(--color-primary)]": backgroundColor.name === "smooth"
     }) }>
      Loş
     </button>
     <button 
